...
BOOST_FIXTURE_TEST_CASE(normalMemoryMode_evalCellVolume, NormalTestPatch)
{
    BITPIT_UNIT_TEST_DISPLAY_NAME(log::cout());
...
BOOST_FIXTURE_TEST_CASE(normalMemoryMode_evalCellSize, NormalTestPatch)
{
    BITPIT_UNIT_TEST_DISPLAY_NAME(log::cout());
...
BOOST_FIXTURE_TEST_CASE(normalMemoryMode_evalCellCentroid, NormalTestPatch)
{
    BITPIT_UNIT_TEST_DISPLAY_NAME(log::cout());
