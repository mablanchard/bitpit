...
int subtest_001()
{
    ...
    std::unique_ptr<bitpit::SurfUnstructured> STL0( new bitpit::SurfUnstructured (0,dimensions - 1,dimensions,MPI_COMM_NULL) );
#else
    std::unique_ptr<bitpit::SurfUnstructured> STL0( new bitpit::SurfUnstructured (0,dimensions - 1,dimensions) );
#endif
...
#if BITPIT_ENABLE_MPI
    std::unique_ptr<bitpit::SurfUnstructured> STL1( new bitpit::SurfUnstructured (0,dimensions - 1,MPI_COMM_NULL) );
#else
    std::unique_ptr<bitpit::SurfUnstructured> STL1( new bitpit::SurfUnstructured (0,dimensions - 1) );
#endif
